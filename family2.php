...
<main>
  ...
  <section>
      ...
      <div class="products" id="about">
          ...
          <div>
              <div class="w3-container " id="family">
                  <h2 class="section-text-header">OUR FAMILY</h2>
              </div>
  ...
  <div class="new-arrived-products">
      <div class="new-product ">
         ...
         <button style = "padding: 10px 5px; background-color: #BC884D" type="button" class="w3-button w3-round" style="color:black" >
            <p style="color:black"><b>DOGS READY FOR ADOPTION</b></p></button></a> 
       </div>
      </div>
     <div class="new-product">
       <div class="new-arrived-image">
        <a href="./petfoster.php">
         <img src="img\foster1_cats.jpg"/>
     </div>
     <div class="w3-margin-top" style="overflow: hidden;  padding: 0px 25px;">
        <button style = "padding: 10px 5px; background-color: #BC884D" type="button" class="w3-button w3-round" style="color:black" >
            <p style="color:black"><b>BECOME A FOSTER PARENT</b></p></button></a>
   </div>
   </div>
   <div class="new-product">
       <div class="new-arrived-image">
     ...
     <div class="w3-margin-top" style="overflow: hidden;  padding: 0px 25px;">
        <button style = "padding: 10px 5px; background-color: #BC884D" type="button" class="w3-button w3-round" style="color:black" >
            <p style="color:black"><b>CATS READY FOR ADOPTION</b></p></button></a>
   </div>
   </div>
  ...
  <div class="w3-center contact" id="contact" >
      <div class=" w3-left-align w3-margin-top contact-info ">
        ...
        <div class="w3-margin-to  w3-left-align">
            <h3 style="font-weight: 800;"><b>Message Us</b></h3>
