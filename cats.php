...
<header class="header" id="top">
        <div class="w3-top">
            <div style ="background-color: #BC884D;" class="w3-bar w3-card header">
              ...
              <a href="profile.php" class="w3-bar-item w3-button w3-padding-large "style="font-family:Times New Roman; font-size: 18px"><b>P.A.W.S</b></a>
              <span class="w3-right">
...
<!--PETS FOR ADOPTION SECTION - yaman ng mga pinapaadopt XD-->
    <h3 class="outlinetitle" style="text-align:center;"><b> Cats for Adoption </b></h3>
    ...
    <div class="new-arrived-products">
        <div class="new-product ">
           <div class="new-arrived-image">
              <img src = "img\cat1_apekz.jpg"/>
           </div>
           <div class="w3-margin-top" style="overflow: hidden; padding:0px 20px;">
<!--Cat 1 information-->
           <h4 style="text-overflow:ellipsis ;overflow: hidden;">4 Weeks Female Cat</h4>
           <p>Playful, friendly, loves attention</p>
           <p class="price">Janna - Persian</p>
         </div>
        </div>
        <div class="new-product">
         <div class="new-arrived-image">
           <img src="img\cat2_jumbo.jpg"/>
         </div>
         <div class="w3-margin-top" style="overflow: hidden; padding:0px 20px;">
<!--Cat 2 information-->
             <h4 style="text-overflow:ellipsis ;overflow: hidden;">2 months Male Cat</h4>
             <p>Friendly, affectionate, gentle, playful</p>
             <p class="price">Luffy - Russian Blue</p>
         </div>
       </div>
       <div class="new-product">
        <div class="new-arrived-image">
          <img src="img\cat7_homre.jpg"/>
        </div>
        <div class="w3-margin-top" style="overflow: hidden; padding:0px 20px;">
<!--Cat 7 information-->
            <h4 style="text-overflow:ellipsis ;overflow: hidden;">2 months Female Cat</h4>
            <p>Friendly, affectionate, gentle, playful</p>
            <p class="price">Lovely - Philippine Shorthair (Puspin)</p>
        </div>
      </div>
       <div class="new-product">
         <div class="new-arrived-image">
           <img src="img\cat3_floyd.jpg"/>
       </div>
       <div class="w3-margin-top" style="overflow: hidden;  padding:0px 20px;">
<!--Cat 3 information-->
         <h4>2 months Male Cat</h4>
         <p>Dominant, Ideal as a solo cat, gentle</p>
         <p class="price">Floyd - Persian Cat</p>
     </div>
       </div>
       <div class="new-product">
         <div class="new-arrived-image">
           <img src="img\cat4_flubert.jpg"/>
         </div>
         <div class="w3-margin-top" style="overflow: hidden;  padding:0px 20px;">
<!--Cat 4 information-->
           <h4>5 weeks Male Cat</h4>
           <p>sweet, friendly, talkative, playful, clingy</p>
           <p class="price">Flubert - Persian Cat</p>
       </div>
      </div>
      <div class="new-product">
       <div class="new-arrived-image">
         <img src="img\cat5_meaw.jpg"/>
       </div>
       <div class="w3-margin-top" style="overflow: hidden; padding:0px 20px;">
<!--Cat 5 information-->
         <h4>4 years Female Cat</h4>
         <p>loves getting pets, friendly, playful</p>
         <p class="price">Sofie - Philippine Shorthair (Puspin)</p>
     </div>
     </div>
     <div class="new-product">
       <div class="new-arrived-image">
         <img src="img\cat6_parel.jpg"/>
     </div>
     <div class="w3-margin-top"  style="overflow: hidden;  padding:0px 20px;">
<!--Cat 6 information-->
       <h4 >2 week Female Cat</h4>
       <p>clingy, beautiful, friendly, playful</p>
       <p class="price">Rona - Philippine Shorthair (Puspin)</p>
   </div>
     </div>
     </div>
  </div>
